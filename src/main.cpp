...
int main(int argc, char *argv[])
{
    ...
    TemporalSignalDisplay disp;
        ...
        disp.setFps(30.f); // watch out fps must be set before setting XY range AND must be the same than the retrieved signals (from serial port or sine generator)
